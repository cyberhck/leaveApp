...
<?php
	if(isset($_POST['submit'])){
		...
		$sql			=		"INSERT INTO `$DB_NAME`.`principal` (`username`,`password`) VALUES('$username','$password')";
		if(mysql_query($sql)){
			header("location:addPrincipal.php?success");
		}else{
			header("location:addPrincipal.php?fail");
		}
			...
			<div class="row">
				<div class="col-md-5" style="text-align:center;margin-top:25px;">
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
						<input type="text" name="username" class="form-control floating-label" placeholder="Principal Username">
