...
<?php
	if(isset($_POST['submit'])){
		...
		$sql			=		"INSERT INTO `$DB_NAME`.`hod` (`username`,`password`,`department`) VALUES('$username','$password','$department')";
		if(mysql_query($sql)){
			header("location:addHod.php?success");
		}else{
			header("location:addHod.php?fail");
		}
			...
			<div class="row">
				<div class="col-md-5" style="text-align:center;margin-top:25px;">
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
						<input type="text" name="username" class="form-control floating-label" placeholder="HOD Username">
